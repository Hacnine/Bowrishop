...
const heroSlides = [
  {
    ...
    titleClass: 'text-[#432718ff]',
    descriptionClass: 'text-[#716b62ff]',
    eyebrowClass: 'text-[#a4907cff]',
    buttonClass: 'bg-[#432718ff] text-white hover:bg-[#2e1a10ff]',
    perksBarClass: 'bg-white/60 backdrop-blur-md border border-white/50',
    perksTitleClass: 'text-[#2e1a10ff]',
    perksDescClass: 'text-[#8a7d70ff]',
    perksDividerClass: 'divide-[#432718ff]/10',
    perks: [
      {
        icon: Sparkles,
  ...
  },
  {
    ...
    titleClass: 'text-[#d0ceccff]',
    descriptionClass: 'text-[#d0ceccff]',
    eyebrowClass: 'text-[#b7aca3ff]',
    buttonClass: 'bg-[#e7c9a0ff] text-[#432718ff] hover:bg-[#dcb789ff]',
  ...
  },
  {
    ...
    objectPosition: 'center center',
    titleClass: 'text-[#1e2a4aff]',
    descriptionClass: 'text-gray-500',
    eyebrowClass: 'text-gray-500',
    buttonClass: 'bg-[#1e2a4aff] text-white hover:bg-[#151d34ff]',
  ...
  },
  {
    ...
    objectPosition: 'center center',
    titleClass: 'text-[#fdfcfcff]',
    descriptionClass: 'text-[#d8cec5ff]',
    eyebrowClass: 'text-[#c9a488ff]',
    buttonClass: 'bg-[#f3d9c9ff] text-[#432718ff] hover:bg-[#e9c6b0ff]',
...
export function Hero({ categories = [] }) {
  ...
  return (
    <section className="relative">
      ...
      {categories.length > 0 && (
        <div className="bg-[#f4efe9] border-b border-gray-200">
